# GPU-based DPF of Lam et al.

GPU-based distributed point functions from the paper [_GPU-based Private Information Retrieval for On-Device Machine Learning Inference_](https://doi.org/10.1145/3617232.3624855), ASPLOS '24
...
2. **Network communication costs are minimized**
   - Key sizes are _compact_ on the order of 2KB for tables with up to 2^32 entries.
