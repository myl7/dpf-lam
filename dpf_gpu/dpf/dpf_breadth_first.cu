...
__global__ void dpf_breadth_first_kernel(SeedsCodewordsFlatGPU *cw, uint128_t_gpu *out,
  uint128_t_gpu *DPF_BREADTH_PARALLEL_KEYS_1, uint128_t_gpu *DPF_BREADTH_PARALLEL_KEYS_2, int batch_size,
  int num_entries) {
  ...
  constexpr int parallel_work_per_threadblock_per_dpf =
    (DPF_BREADTH_PARALLEL_THREADS_PER_BLOCK / DPF_BREADTH_PARALLEL_DPFS_PER_BLOCK);
...
void dpf_breadth_first(SeedsCodewordsFlatGPU *cw, uint128_t_gpu *out, int batch_size, int num_entries, cudaStream_t s) {
  ...
  dpf_breadth_first_kernel<<<n_blocks_breadth_parallel, n_threads_breadth_parallel, 0, s>>>(
    cw, out, DPF_BREADTH_PARALLEL_KEYS_1, DPF_BREADTH_PARALLEL_KEYS_2, batch_size, num_entries);
}
