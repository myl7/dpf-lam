...
__global__ void dpf_naive_kernel(SeedsCodewordsFlatGPU *cw, uint128_t_gpu *out, int batch_size) {
...
void dpf_naive(SeedsCodewordsFlatGPU *cw, uint128_t_gpu *out, int batch_size, int num_entries, cudaStream_t s) {
