...
__global__ void test_uint128_from_kernel(uint128_t_gpu *r) {
  *r = uint128_from(0x1234567823456789, 0x2345678934567890);
}
...
__global__ void test_add_uint128_kernel(uint128_t_gpu *a, uint128_t_gpu *b, uint128_t_gpu *r) {
  *r = add_uint128(*a, *b);
}
...
__global__ void test_mul_uint128_kernel(uint128_t_gpu *a, uint128_t_gpu *b, uint128_t_gpu *r) {
  *r = mul_uint128(*a, *b);
}
...
__global__ void test_mul_uint128_kernel_twice(uint128_t_gpu *a, uint128_t_gpu *b, uint128_t_gpu *c, uint128_t_gpu *r) {
...
void test_mul_uint128_twice() {
  ...
  cudaMemcpy(a_gpu, &a, sizeof(uint128_t_gpu), cudaMemcpyHostToDevice);
  cudaMemcpy(b_gpu, &b, sizeof(uint128_t_gpu), cudaMemcpyHostToDevice);
  cudaMemcpy(c_gpu, &c, sizeof(uint128_t_gpu), cudaMemcpyHostToDevice);
